...
if (isset($_POST['submit_issue'])) {
    ...
    for ($i=0; $i < count($_POST['item']); $i++) {   
        ...
        $sql = "INSERT INTO receive_grn(receive_token, item_name, quantity_received, created_at, created_by, type, tfrom, tto, status, receive_type)
                VALUES('$r_token', '$item_n', '$quantity', now(), '$created_by', 0, '$name', '$received_from', 0, 1)";
    ...
    $_SESSION['msg'] = '<span class="alert alert-success">Issue Item Initiated Successfully.</span>';
                    ...
                    <div class="container">
                                ...
                                <div class="crcform">
                                    ...
                                    <form action="" method="post">
                                                ...
                                                <td>
                                                    <div class="form-row">
                                                        <div class="col-md-4 mb-3">
                                                            <label for="validationCustom01">Issuing To</label>
                                                                <input type="text" class="form-control" name="to" id="validationCustom05" placeholder="Issue To" required="">
                                                        </div>
                                                    </div><hr>
                                                    <div class="form-row">
                                                        <div class="col-md-4 mb-3">
                                                            <label for="validationCustom01">Issuing From</label>
                                                        ...
                                                        <div class="col-md-4 mb-3">
                                                            ...
                                                            <select name="from" id="tlocation" class="sele custom-select border-0 pr-3" required>
                                        ...
                                        <input type="submit" name="submit_issue" id="submit"  class="btn btn-info" value="Submit" />
                                    </form>
                                </div>
                                <br>
                    </div>
